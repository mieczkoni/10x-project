...
export const listCardsQuerySchema = z
  .object({
    ...
    // Filters
    deckId: z.string().uuid({ message: "Invalid deck ID format" }).optional(),
...
export const createCardSchema = z.object({
  deck_id: z.string({ required_error: "deck_id is required" }).uuid({ message: "Invalid deck ID format" }),
  ...
  ai_generated: z.boolean({ required_error: "ai_generated is required" }),
});
