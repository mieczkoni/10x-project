...
export type DeckActionVm = {
  isRenaming: boolean
  isDeleting: boolean
  error?: string
}

export type CardListItemVm = {
  id: CardId
  front: string
  back: string
  tags: string[]
...
export type CardsPageVm = {
  nextCursor: string | null
  limit: number
  cursorStack: string[]
}

export type TagOptionVm = {
  value: string
  label: string
  count?: number
}

export type DuplicateWarningVm = {
